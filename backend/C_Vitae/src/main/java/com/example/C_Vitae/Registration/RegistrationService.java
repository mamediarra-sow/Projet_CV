...
import com.example.C_Vitae.Email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request){
        ...
        String link = "http://localhost:8080/api/accueil/confirm?token="+token;
        emailSender.Send(
                request.getEmail(),buildEmail(request.getPrenom(),link));
